...
class VehicleMaintainanceAdmin(admin.ModelAdmin):
    list_display = ("vehicle_number", "last_service", "servicing_days_remaining", "insurance_exp_remaining","insurance_status","puc_exp","puc_exp_remaining", "puc_status", "updated_at")
